...
const Post = ({buyNow, addToCart, product, variants}) => {
  ...
  const refreshVariant = (newsize, newcolor)=>{
    console.log('variants is v', variants)
      ...
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              <span className="title-font font-medium text-2xl text-gray-900">Rs.499</span>
              <button onClick={()=>{buyNow(slug, 1, 499, product.title, size, color)}} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
